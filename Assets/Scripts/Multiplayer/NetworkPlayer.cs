...
//	public GameObject[] MovingProjectiles;
...
//	static Dictionary<int,NetworkPlayer> _playerIdToNetworkPlayerDict = new Dictionary<int, NetworkPlayer>();
...
//
//	Dictionary <string,GameObject> _movingProjectileDict = new Dictionary<string, GameObject>();
//
//	GameObject _currentMovingProjectile;
//
//	int _team = -1;
//	int _idleHash;
//	int _walkHash;
...
//		}
//
//		foreach (GameObject projectile in MovingProjectiles)
//		{
//
//			_movingProjectileDict.Add(projectile.GetComponent<MovingProjectileObj>().ProjectileName,projectile);
//		}
//
//		_playerIdToNetworkPlayerDict.Add(photonView.ownerId,this);
//		
//		yield return null;
//	}
//
//	public static NetworkPlayer Find(int playerId)
//	{
//	
//		return _playerIdToNetworkPlayerDict[playerId];
//	}
//	
//
//	[RPC]
...
////	}
//
//	public void FireMovingProjectile(string projectileName, Vector3 startPos, Quaternion rotation, float speed)
//	{
//		float startTime = (float)PhotonNetwork.time;
//
//
//		photonView.RPC("FireMovingProjectileRPC",PhotonTargets.All,projectileName, startPos,rotation,speed,startTime);
//
//	}
//
//	[RPC]
//	void FireMovingProjectileRPC(string projectileName, Vector3 startPos, Quaternion rotation, float speed, float startTime)
//	{
//	
//		GameObject rocket = (GameObject)Instantiate(_movingProjectileDict[projectileName],startPos,rotation);
//
//		float timeDelta = (float)PhotonNetwork.time - startTime;
//		rocket.transform.position += rocket.transform.forward * speed * timeDelta;
//
//		rocket.GetComponent<MovingProjectileObj>().Fire(speed,photonView.isMine,this);
//
//	}
//
...
//		
//		if (shootingPlayerView != null)
//			Debug.Log("found id: " + shootingPlayerViewId);
//
...
////
//		if (shootingPlayerView == null)
//			Debug.Log("couldn't find id: " + shootingPlayerViewId);
//		else
//			Debug.Log("gameobj: " + shootingPlayerView.gameObject.name);
//
...
//	{
//		if (photonView.ownerId == player.ID)
//		{
//			if (IsHoldingFlag())
//				GetHeldFlag().SendMessage("OnDroppedFlag",this);
//		}
